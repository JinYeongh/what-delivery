...
public:
    ...
    void handleOrderResponse(const QJsonObject &resp);
...
private:
    ...
    std::function<void(const QJsonObject&)> responseHandler_;  // 콜백 핸들러
};
